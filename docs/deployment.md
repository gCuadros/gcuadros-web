...
4. Tras la primera ejecución de CI, proteger `main`: exigir PR, los checks `Quality checks`, `Production build` y `Browser and accessibility`, resolver conversaciones e impedir force pushes y borrados.
