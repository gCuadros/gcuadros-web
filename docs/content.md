...
- El caso Hevy está en `src/app/proyectos/hevy/page.tsx`, basado en el README público revisado el 23/09/2026. Sus afirmaciones distinguen anotaciones MCP de confirmaciones implementadas por el cliente.
